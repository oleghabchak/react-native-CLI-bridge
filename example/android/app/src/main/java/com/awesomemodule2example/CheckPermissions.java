...
public class CheckPermissions {
    ...
    public CheckPermissions(Context ctx, View view_snack, iCheckPermission interf) {
        ...
        massPermiss[0] = new TPermission(1, android.Manifest.permission.ACCESS_FINE_LOCATION,
                messageLocationPermission);
        massPermiss[1] = new TPermission(2, android.Manifest.permission.WRITE_EXTERNAL_STORAGE, messageWritePermission);
        massPermiss[2] = new TPermission(3, android.Manifest.permission.READ_PHONE_STATE, messagePhoneStatePermission);
    ...
    public static boolean hasLocationPermissions(Context context) {
        return hasPermissions(context, new String[] { android.Manifest.permission.ACCESS_FINE_LOCATION });
    }

    public static boolean hasWriteExternalStorePermissions(Context context) {
        return hasPermissions(context, new String[] { android.Manifest.permission.WRITE_EXTERNAL_STORAGE });
    }

    public static boolean hasReadPhoneStatePermissions(Context context) {
        return hasPermissions(context, new String[] { android.Manifest.permission.READ_PHONE_STATE });
    }
